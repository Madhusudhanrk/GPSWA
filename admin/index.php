                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            <small>Welcome To Your Data</small>
            ...
            <div class="row">
              ...
              <?php
                  ...
                  $query = "SELECT * FROM post WHERE post_user = $user_id";
                    $select_post_query = mysqli_query($dbcon,$query);
                    $post_count = mysqli_num_rows($select_post_query);
                    if(!$post_count==0)
                    querychecker($post_count);
              ?>      
        ...
        <div class="panel-heading">
            <div class="row">
                ...
                <?php 
                    ...
                    $query = "SELECT * FROM comments WHERE comment_user = '$author' ";
                    $select_comment_query = mysqli_query($dbcon,$query);
                    $comments_count = mysqli_num_rows($select_comment_query);
                    if(!$comments_count==0)
                    querychecker($comments_count);
        ...
        <div class="panel-heading">
            <div class="row">
                ...
                <div class="col-xs-9 text-right">
                  <?php 
                    $userid = $_SESSION['userid'];
                    $query = "SELECT * FROM categories WHERE cat_user_id = $userid ";
                    $select_categories_query = mysqli_query($dbcon,$query);
                    $categories_count = mysqli_num_rows($select_categories_query);
                    if(!$categories_count==0)
                    querychecker($categories_count);     
                  ?>      
